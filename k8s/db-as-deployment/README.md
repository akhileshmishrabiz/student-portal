# Postgres as a Deployment

Runs Postgres 15 as a single-replica **Deployment** with a **PersistentVolumeClaim**.

> **Note:** Deployments can reschedule pods to different nodes. For production Postgres, prefer `../db-as-statefulset/` (stable pod identity + ordered storage).
